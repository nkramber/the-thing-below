...
| Question | The answer | Note |
|---|---|---|
| The body sizes | 24, 32, and 48 frame pixels | 24 and 32 draw their own strike at 1x, and 48 doubles the 24 strike |
| The title sizes | 32, 48, and 64 frame pixels | One step above the body. 32 is the largest strike, so 48 and 64 double a smaller one |
...
The owner asked whether one text size can remove the UI scale setting of D-639. A body of 48
can. It doubles the 24 strike, so a glyph pixel takes 2 frame pixels. Thus the floor of D-639
holds on the Deck at a fit of 1x. A body of 24 and a body of 32 draw their own strike at 1x,
and they miss that floor.

...
Region one takes place in mid-winter (D-253). The high pass lies deep in snow. After the story of region one ends, two months pass, and the next region begins as winter turns to spring.

## The layout on the mountain

From the high pass down to the foothills (D-250, D-255, D-371):

| Height | Place | Kind |
|---|---|---|
| High pass | The ice crossing, over the pass and out of the region | Dungeon |
...
- Two people of note: an old-faith hexer and a cutpurse's fence (D-246). They teach or give lessons to the party (D-365).

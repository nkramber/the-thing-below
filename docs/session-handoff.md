...
The review record and this entry are committed in `b4e6f6a` and pushed to the PR branch. GitHub reports the same head.
...
The review record and this entry are committed in `b4e6f6a` and pushed to the PR branch. GitHub reports the same head. The verdict applies to effective head `7732b1b`.

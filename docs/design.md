...
| F-66 | The Deck sweep of 2026-09-17 found no limit. Each of the 20 stages held 60 frames per second under both renderers, and the heaviest stage, 15 lights with 8192 particles and a transition, gave 5.00 ms at the 95th percentile under Mobile. The sweep stopped at 15 lights because of F-46, and it stopped at 8192 particles by its own table. So the effect budget of D-523 holds the largest load that the test measured, and not the ceiling of the machine | 2026-09-17 | ⚠ Binds PR-56 to PR-60 and D-617: each budget row is a floor, and a row rises only with a new measurement before it and after it (G-14) |

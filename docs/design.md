...
27. **G-27.** Every effect draws with the palette of 64 colors and hard edges, and no smooth gradient. The rule covers each particle and each transition (D-181, D-622). The fog alone fades in 2 to 8 steps over blocks of art pixels (D-900, D-907). The glow alone blooms smoothly, and its colors can leave the palette (D-911). The owner reads each new effect as its PR lands (D-623).
...
21. PR-59: the glow on light sources alone, first on fire (D-188, D-910 to D-912).

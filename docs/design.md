...
| F-102 | The owner read the fog of PR-94 round 1 and refused it, with a reference picture of soft mist. The fog of round 1 cut its noise into hard bands of blocks of 2 to 4 pixels, with a dark key at 18 percent at most. The reference fades smoothly from clear to a pale gray of about 45 percent | 2026-09-22 | ✅ PR-94: the fog fades in steps over blocks of art pixels, in the pale key `L`, with a fractal noise and a floor of 17 for the fog test (D-900 to D-907) |
...
20. PR-94: the procedural fog, a soft noise shader of 1 to 3 layers in place of the text grid (D-896 to D-907).

...
- PR-103 widens that halo to 168 pixels (D-1092). After a playtest, the wall torch holds a glow of strength 0, so it draws no halo (D-1097). Its light is one less the square of the distance, to the power 4. It meets 0 at its edge with no slope, so it shows no ring (D-1095).

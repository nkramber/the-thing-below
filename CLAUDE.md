...
- The override set holds `docs/`, `README.md`, `CLAUDE.md`, `AGENTS.md`, `.claude/` without its settings files, and `.github/pull_request_template.md` (D-16, D-71, D-239, D-700, D-1085). Every other path takes the review, `.github/workflows/` and `content/` included (D-185, D-560).

...
public sealed class SimulationTests
{
    ...
    public void AMenuHoldsTheStepOfThePartyBack()
    {
        ...
        // (D-162, D-650).
        Simulation open = Simulation.Start(Seed, TestMaps.Room, TestBattles.Content, TestBattles.Notices, TestBattles.Story, DebugIntentHandlers.None);
        Simulation closed = Simulation.Start(Seed, TestMaps.Room, TestBattles.Content, TestBattles.Notices, TestBattles.Story, DebugIntentHandlers.None);
    ...
    public void ADebugIntentReachesTheHandlerOfTheHost()
    {
        ...
        Simulation run = Simulation.Start(Seed, TestMaps.Room, TestBattles.Content, TestBattles.Notices, TestBattles.Story, handlers);
    ...
    {
        RunSnapshot start = Simulation.Start(Seed, TestMaps.Room, TestBattles.Content, TestBattles.Notices, TestBattles.Story, DebugIntentHandlers.None).Snapshot();
    ...
    {
        RunState state = RunState.Start(Seed, TestMaps.Room, TestBattles.Content, TestBattles.Notices, TestBattles.Story);

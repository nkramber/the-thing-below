...
public sealed class RunReplayTests
{
    ...
    public void AThousandSeedsEachReplayToTheirOwnEndState()
    {
        ...
        for (ulong seed = 1; seed <= 1_000; seed += 1)
        {
            ...
            RunState replayed = RunReplay.Play(record, ContentHash, TestMaps.Room, TestBattles.Content, TestBattles.Notices, DebugIntentHandlers.None);
    ...
    public void ARecordWithADebugIntentReplaysOnAHostWithTheHandler()
    {
        ...
        RunState replayed = RunReplay.Play(record, ContentHash, TestMaps.Room, TestBattles.Content, TestBattles.Notices, handlers);
    ...
    public void AReplayRunsTheTicksAfterTheLastIntent()
    {
        ...
        RunState replayed = RunReplay.Play(recorder.Build(), ContentHash, TestMaps.Room, TestBattles.Content, TestBattles.Notices, DebugIntentHandlers.None);

...
public sealed class StatusSnapshotTests
{
    ...
    public void ASnapshotWithStatusesReadsBackToTheSameState()
    {
        ...
        Simulation resumed = Simulation.Resume(Seed, Read(line), BattleRuns.Map("group.one"), TestBattles.Content, DebugIntentHandlers.None);
    ...
    public void AStatusThatTheEnemyRefusesFailsTheResume()
    {
        ...
        ArgumentException error = Assert.Throws<ArgumentException>(
            () => Simulation.Resume(Seed, broken, BattleRuns.Map("group.one"), content, DebugIntentHandlers.None));

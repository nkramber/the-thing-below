...
public sealed class CrashTextTests
{
    ...
    public void TheRecordOfACrashFileReachesTheStateHashOfTheRun()
    {
        ...
        RunState replayed = RunReplay.Play(read.Record!, SaveRuns.ContentHash, TestMaps.Room, TestBattles.Content, TestBattles.Notices, TestBattles.Story, DebugIntentHandlers.None);

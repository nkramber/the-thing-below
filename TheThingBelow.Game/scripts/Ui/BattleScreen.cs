...
public sealed class BattleScreen
{
    ...
    {
        BattleEventKind.Hit or BattleEventKind.Absorb or BattleEventKind.Item or BattleEventKind.Heal or BattleEventKind.Revive => playing.Target,
            ...
            case CommandStage.Item:
                foreach (PackValues entry in open.Items)
                {
                    entries.Add((
                        ...
                        Values(
                            ("item", this.content.Strings.Text(BattleMessages.NameIdOf(entry.Id))),

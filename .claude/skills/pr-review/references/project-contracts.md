...
| Presentation | Gamepad and keyboard play, the one 16:9 frame of 1280 by 720 with 32-pixel tiles, black bars for every other shape and the Deck, a fit that looks good at 1920 by 1080, the Deck readability floor, the style of each effect, and the atlas test (D-84, D-92, D-107, D-228, D-568, D-622). Each art batch has its review sheets in the PR description, each drawing file is JSON, and a rule file never names art (D-514, D-515, D-519). Each story batch has its screenplay in the PR description (D-1015, D-1016). Each effect stays inside the effect budget, the world waits for an effect only through a wait intent, and each flash and shake has its reduced form (D-214, D-522, D-523). Game draws the world at 1x and builds the fit of D-232 itself, and each font keeps its pixel settings (F-48, F-49). Headless tests do not establish visual quality or game feel. |

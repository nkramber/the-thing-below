...
| Term | Use for | Do not use |
|---|---|---|
| docs-only PR | a PR whose paths are all in the override set: `docs/`, `README.md`, `CLAUDE.md`, `AGENTS.md`, `.claude/` without `.claude/settings.json` and .claude/settings.local.json, and the PR template (D-16, D-513, D-700, D-1086) | documentation PR, when the text means this set |

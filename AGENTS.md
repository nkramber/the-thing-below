...
**Gitar pause (D-895).** No PR waits for the gitar pass or answers it. The label below applies after ste-check is green. The rules below stand again when the pause ends.
...
- [ ] The automated pass of gitar approved the head, or every comment of the pass has its answer (D-14). The review is current under the `gitar-review` skill, or the pause of D-895 holds.
